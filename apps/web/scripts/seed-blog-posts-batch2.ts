...
const nationalParksBody = [
...

  {
    ...
    _key: key(),
    items: [
      { icon: '🎒', text: 'Neutral clothing (khaki, olive, beige)' },
      { icon: '🔭', text: 'Binoculars (essential — 8x42 or 10x42)' },
      { icon: '📸', text: 'Camera with long lens (200mm minimum)' },
      { icon: '🧴', text: 'Sunscreen SPF 50+' },
      { icon: '🦟', text: 'DEET mosquito repellent' },
      { icon: '💊', text: 'Malaria prophylaxis (start before travel)' },
      { icon: '🥾', text: 'Comfortable walking shoes' },
      { icon: '🧣', text: 'Light fleece (cold mornings in the Mara)' },
      { icon: '💧', text: 'Reusable water bottle' },
      { icon: '🎩', text: 'Wide-brim hat (shade in open vehicles)' },
      { icon: '📱', text: 'Offline maps (iOverlander or Maps.me)' },
      { icon: '💵', text: 'Cash in KES (many camps, cash only)' },
    ],
  },
...
const watamuTransportBody = [
...

  {
    ...
    _key: key(),
    headers: ['Route', 'Option', 'Cost (KES)', 'Time'],
    rows: [
