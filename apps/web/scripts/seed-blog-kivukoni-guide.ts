...
const kivukoniGuideBody = [
  ...
  // ── Fees ──
  textBlock(`Fee Structure 2026', 'h2`),

  textBlock(`Kivukoni publishes its fees openly, which we appreciate. Here is the full breakdown for the 2025/2026 academic year. All figures are annual and in Kenyan Shillings.`),

  {
    _type: 'budgetTableBlock',
    _key: key(),
    columns: ['Year Group', 'Annual Fee (KSh)'],
    rows: [
      { _key: key(), label: 'Playgroup', values: ['98,000'] },
      { _key: key(), label: 'FS1 (Reception)', values: ['133,000'] },
      { _key: key(), label: 'FS2', values: ['163,000'] },
      { _key: key(), label: 'Years 1 - 2 (KS1)', values: ['216,500'] },
      { _key: key(), label: 'Years 3 - 6 (KS2)', values: ['284,500'] },
      { _key: key(), label: 'Years 7 - 9 (KS3)', values: ['362,000'] },
      { _key: key(), label: 'Years 10 - 11 (iGCSE)', values: ['395,000'] },
    ],
    totalRow: ['iGCSE (highest)', 'KSh 395,000 / year'],
  },

  textBlock(`On top of tuition there is a one-time admission fee of KSh 15,000 and a refundable caution deposit of KSh 40,000. Transport runs KSh 25,000 to 45,000 per term depending on your route. The important thing to know is that fees include everything  --  all textbooks, lunch, snacks, sports, and swimming. There are no hidden extras for uniforms or exam registration that suddenly appear mid-year.`),

  textBlock(`Discounts are available: 5 per cent off if you pay the full year upfront, and an 8 per cent sibling discount. For a family with two children in primary, that sibling discount is meaningful. Compared to Nairobi international schools  --  where annual fees can run KSh 1.5 million to 3 million  --  Kivukoni is genuinely affordable, especially considering what is included.`),
...

  {
    ...
    rows: [
      ...
      {
        _key: key(),
        criterion: 'Annual fees (primary)',
        values: ['KSh 216 - 284K', 'KSh 1.5 - 3M', 'KSh 15 - 50K'],
        winners: [true, false, false],
      },
      {
        _key: key(),
...
async function main() {
  await client.createOrReplace({
    ...
    seoDescription:
      'Kivukoni International School in Kilifi: British curriculum, iGCSEs, off-grid eco campus, fees from KSh 98K. The honest parent\'s guide for 2026.',
    excerpt:
      'Kivukoni International School sits on Kilifi Plantation beside Takaungu Creek  --  an off-grid, solar-powered campus where 280 kids from 2 to 16 learn the British curriculum surrounded by nature. Here\'s what parents need to know.',
    readingTime: 10,
