...
const HIDDEN_ROUTES = ["/admin", "/studio", "/api", "/coming-soon", "/claim", "/login", "/register", "/forgot-password", "/reset-password", "/dashboard", "/account", "/m", "/pos", "/receipt", "/kitchen", "/embed", "/scan", "/eat", "/eatklick"];
