/**
 * POST /api/setup/dismiss — owner clicked "Hide this banner" without
 * finishing the wizard.
 *
 * Body: { menu_id }
 *
 * Banner stops showing once this is set. Distinct from /api/setup/complete
...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    console.error("[setup/dismiss POST] error:", error);
