  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <span className={`inline-flex items-center px-3 py-1 rounded-full text-[12px] font-semibold ${RESERVATION_STATUS_BADGE[reservation.status] ?? "bg-[#F0EDE8] text-text3"}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-[#F0EDE8] p-6 space-y-4">
            <h2 className="text-[16px] font-display font-bold text-dark">Reservation Details</h2>
          ...
          {reservation.internal_notes && (
            <div className="bg-white rounded-2xl border border-[#F0EDE8] p-6">
              <h2 className="text-[16px] font-display font-bold text-dark mb-3">Internal Notes</h2>
              <p className="text-[13px] text-dark whitespace-pre-wrap">{reservation.internal_notes}</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-[#F0EDE8] p-6 space-y-3">
            ...
            {reservation.guest_email && (
              <p className="text-[12px] text-text3 pt-1 border-t border-[#F0EDE8]">
                {reservation.guest_email}
              </p>
            )}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#F0EDE8] p-6 space-y-3 text-[12px]">
            <h2 className="text-[14px] font-display font-bold text-dark">IDs</h2>
...
function Field({
  ...
  return (
    <div>
      ...
      <p className={`text-[14px] text-dark ${mono ? "font-mono text-[12px]" : ""}`}>
        {value ?? "—"}
      </p>
    </div>
  );
