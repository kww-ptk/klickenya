    ...
    <div>
      ...
      {dead.length === 0 ? (
        <div className="bg-white rounded-2xl border border-border p-8 text-center">
          ...
          <p className="font-display text-[16px] font-bold text-dark">Everything is moving</p>
          <p className="text-[13px] text-text3 mt-1">
        ...
        <>
          <div className="bg-white rounded-2xl border border-border p-5 mb-4">
            <p className="text-[11px] font-bold text-text3 uppercase tracking-wide">Money tied up</p>
                ...
                <tbody className="divide-y divide-surface">
                  {dead.map((r) => (
                    <tr key={r.ingredient_id} className="text-[13px]">
                      ...
                      <td className="px-4 py-3 text-text3 hidden sm:table-cell">{fmtRel(r.last_sale_at)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
