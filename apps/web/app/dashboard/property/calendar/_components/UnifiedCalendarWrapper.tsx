    ...
    <div className="mb-5">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 lg:gap-3">
        ...
        <div className="bg-white rounded-xl border border-[#E2DDD5] py-3 px-3 shadow-sm">
          ...
          <p className="text-[10px] lg:text-[11px] text-[#9C9485] font-medium mt-1">Occupied tonight</p>
        </div>
        ...
        >
          <div className="flex items-start justify-between gap-1">
            <p className="font-display text-[20px] lg:text-[22px] font-bold tracking-[-0.02em] leading-none text-[#16A34A]">
              {checkInBookings.length}
            </p>
            {checkInBookings.length > 0 && (
              <svg
                className={`size-3.5 text-[#16A34A] shrink-0 mt-0.5 transition-transform ${expanded === "checkin" ? "rotate-180" : ""}`}
        ...
        >
          <div className="flex items-start justify-between gap-1">
            <p className="font-display text-[20px] lg:text-[22px] font-bold tracking-[-0.02em] leading-none text-[#E8A020]">
              {checkOutBookings.length}
            </p>
            {checkOutBookings.length > 0 && (
              <svg
                className={`size-3.5 text-[#E8A020] shrink-0 mt-0.5 transition-transform ${expanded === "checkout" ? "rotate-180" : ""}`}
                fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
              </svg>
        ...
        <div className="bg-white rounded-xl border border-[#E2DDD5] py-3 px-3 shadow-sm col-span-2 sm:col-span-1">
          ...
          <p className="text-[10px] lg:text-[11px] text-[#9C9485] font-medium mt-1">Revenue this month</p>
        </div>
      </div>
