export default function PropertyDashboardLoading() {
  return (
    <div className="animate-pulse">
      {/* Header */}
      <div className="mb-5">
        <div className="h-4 w-24 bg-[#F4F1EC] rounded mb-2" />
        <div className="h-7 w-52 bg-[#E2DDD5] rounded-lg" />
        <div className="h-4 w-36 bg-[#F4F1EC] rounded mt-1.5" />
      </div>
      ...
      {/* Calendar skeleton */}
      <div className="mb-5">
        <div className="h-5 w-40 bg-[#E2DDD5] rounded mb-3" />
        <div className="bg-white rounded-xl border border-[#E2DDD5] shadow-sm overflow-hidden">
          <div className="h-12 bg-[#FAFAF8] border-b border-[#E2DDD5]" />
