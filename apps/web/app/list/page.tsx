    ...
    <main className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="bg-white border-b border-[#E2DDD5]">
        <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
          <p className="text-sm font-semibold text-[#E8A020] uppercase tracking-widest mb-2">
            List your business
          </p>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#16130C] leading-tight mb-3">
            Reach thousands of visitors across Kenya
          </h1>
          <p className="text-base text-[#5E5848] max-w-xl">
